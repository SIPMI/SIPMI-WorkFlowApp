...
function deleteTemplate(deleteTemplateId) {
    var target = document.getElementById("deleteTemplateForm");
    $("#deleteTemplateId").val(deleteTemplateId);
